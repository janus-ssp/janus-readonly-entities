...
namespace Janus\Component\ReadonlyEntities\Entities\Connection\Revision;
 ...
 * )
 */
class BlockedConnectionRelation
{
    /**
     * @var Connection\Revision
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="Janus\Component\ReadonlyEntities\Entity\Connection\Revision", inversedBy="blockedConnectionRelations")
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="Janus\Component\ReadonlyEntities\Entity\Connection")
